    ...
    return (
        <div className='mt-12 flex gap-x-8 gap-y-16 justify-between flex-wrap'>
            <Link href="/test" className='w-full flex flex-col gap-4 sm:w-[45%] lg:w-[22%]'>
               <div className='relative w-full h-80'>
                ...
                <div className='flex justify-between'>
                    <span className='font-medium'>Asymmetric Ring</span>
                    <span className='font-semibold'>$15,095.00</span>
                </div>
                <div className='text-sm text-gray-500'>Shine in the Pandora Nova 14k Gold Lab-grown Diamond Asymmetric Ring.</div>
            ...
            <Link href="/test" className='w-full flex flex-col gap-4 sm:w-[45%] lg:w-[22%]'>
                ...
                <div className='flex justify-between'>
                    <span className='font-medium'>Bee Dangle Charm</span>
            ...
            <Link href="/test" className='w-full flex flex-col gap-4 sm:w-[45%] lg:w-[22%]'>
                ...
                <div className='flex justify-between'>
                    <span className='font-medium'>Infinity Stud Earrings</span>
            ...
            <Link href="/test" className='w-full flex flex-col gap-4 sm:w-[45%] lg:w-[22%]'>
                ...
                <div className='text-sm text-gray-500'>This 14k gold-plated bracelet sparkles with 48 round prong-set stones.</div>
                <button className='rounded-2xl ring-1 ring-black text-black py-2 px-4 text-xs hover:bg-black hover:text-white'>Add to Bag</button>
            </Link>
